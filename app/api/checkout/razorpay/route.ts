...
/**
 * Deliberately carries NO basket. The lines were priced and stored when the
 * order was created; a verify that described the goods again would let the
 * browser restate them after paying. See lib/razorpayVerify.
 */
